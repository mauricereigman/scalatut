...
import AssignmentC.models.Movie
import javax.inject.Inject
import play.api.libs.json.Json
import play.api.mvc.{AbstractController, ControllerComponents}

/** Assignment C goal: 'getting to know implicits'
  ...
  * collection so it now returns a GoodMovie containing a the list of actors in de movies method
  *
